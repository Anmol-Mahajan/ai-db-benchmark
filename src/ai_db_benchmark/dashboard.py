      ...
      <div class="wrap">
        <div class="section-head">
          <div>
            ...
            <p class="subtle">Median latency by database for the same complex account-health workload, measured locally on the same hardware.</p>
          </div>
  ...
  <script>
    ...
    function renderHero(rows) {
      ...
      document.getElementById("heroBoard").innerHTML = [
        ...
        ["Best Recall@10", bestRecall ? bestRecall.toFixed(3) : "pending", `${vectorDbCount} vector DBs`],
